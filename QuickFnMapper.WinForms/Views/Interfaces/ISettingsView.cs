// File: QuickFnMapper.WinForms/Views/Interfaces/ISettingsView.cs
...
namespace QuickFnMapper.WinForms.Views.Interfaces
{
    ...
    public interface ISettingsView
    {
        ...
        /// <summary>
        /// <para>Occurs when the view is loaded and ready for initialization with current settings.</para>
        /// <para>Xảy ra khi view được tải và sẵn sàng để khởi tạo với các cài đặt hiện tại.</para>
        /// </summary>
        ...
        /// </summary>
        event EventHandler? SaveSettingsClicked; // Sửa: Thêm '?'
        ...
        /// </summary>
        event EventHandler? CancelSettingsClicked; // Sửa: Thêm '?'
        ...
        /// </summary>
        event EventHandler? BrowseRulesFilePathClicked; // Sửa: Thêm '?'
        #endregion
    }
}